  ...
  group('SQLite Repositories End-to-End Tests', () {
    ...
    test('Session lifecycle, active session recovery, and multi-session resume',
      ...
      await categoryRepo.create(Category(
          ...
          updatedAt: now));
      await tagRepo.create(
          Tag(id: 'tag-1', workspaceId: wsId, name: 'Urgent', createdAt: now));
      await tagRepo.create(
          Tag(id: 'tag-2', workspaceId: wsId, name: 'Backend', createdAt: now));
      await personRepo.create(Person(
          id: 'person-1', workspaceId: wsId, name: 'Alice', createdAt: now));
      await workItemRepo.create(WorkItem(
        id: 'wi-1',
        workspaceId: wsId,
        name: 'API Redesign',
